...
function renderizarErrores(listado) {// listado equivale a decir "datos" de la lînea 72
...
function validarInformacion(usuario) {
    ...
    if (usuario.hobbies.length > 4 || usuario.hobbies.length == 0) {
        errores.push("Sólo es posible seleccionar entre 4 hobbies, y como mínimo u1")
    }
